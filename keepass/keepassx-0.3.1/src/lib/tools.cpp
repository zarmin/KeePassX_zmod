...
//	if( UrlString.startsWith("ftp://") && UrlString.length()>6) {
	//	QProcess::startDetached(QString("lxterminal -e 'mc \"").append(UrlString.right(UrlString.length()-6)).append("\"'"));
//		QProcess::startDetached(QString("lxterminal -e 'mc ").append(UrlString).append("'"));
//
//		return;
//	}
